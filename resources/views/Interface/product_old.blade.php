        ...
        <!-- start content -->
            <div class="container" style="margin-top: 80px;">
                ...
                @foreach($Prodects as $Prodect)
                      <div class="col-md-3 item member" style="max-height: 311px;">
                        <img src="{{$Prodect->img}}" class="img-fluid"class="bg" alt="...">
                            <div class="caption" >
                              <div style="margin-top: 40px;">
                                <h2>kenay</h2>
                                <a href="{{route('product_child',$Prodect->id)}}" style="text-decoration: none; font-size: 40px; font-weight: 700; color: cornsilk;">{{$Prodect->name}}</a>
                              </div>
                          </div>
                      </div>
                  @endforeach
