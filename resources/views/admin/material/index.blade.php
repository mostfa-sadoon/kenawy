...
@endsection
@section('add_new')
<a href="{{route('create_material',0)}}" class="btn btn-light-warning font-weight-bolder btn-sm" >Add New materil</a>
@endsection
@section('content')
            ...
            <div class="card-body p-0">
              ...
              <div class="overlay-layer align-items-end justify-content-center">
                ...
                <div class="d-flex flex-grow-1 flex-center bg-white-o-5 py-5">
                  <a href="{{route('child_material',$material->id)}}" class="btn font-weight-bold btn-primary btn-shadow">Explore</a>
                  <a href="{{route('edit_material',$material->id)}}" class="btn font-weight-bold btn-light-primary btn-shadow ml-2">edit</a>
                  <a href="{{route('delete_material',$material->id)}}" class="btn font-weight-bold btn-light-primary btn-danger ml-2">delete</a>
                </div>
              </div>
            </div>
          </div>
