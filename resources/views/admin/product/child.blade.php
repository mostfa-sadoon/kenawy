...
@endsection
@section('add_new')
<a href="{{route('create_product',$product->id)}}" class="btn btn-light-warning font-weight-bolder btn-sm" >Add New materil</a>
@endsection
@section('content')
            ...
            <div class="card-body p-0">
              ...
              <div class="overlay-layer align-items-end justify-content-center">
                <div class="d-flex flex-grow-1 flex-center bg-white-o-5 py-5">
                  <a href="{{route('delete_child_product',$product->id)}}" class="btn font-weight-bold btn-light-danger btn-shadow ml-2">delete</a>
                </div>
              </div>
            </div>
          </div>
